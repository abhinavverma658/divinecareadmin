...
import EditPrivacyPolicy from "./Pages/websitePages/EditPrivacyPolicy.jsx";
import EditTermsConditions from "./Pages/websitePages/EditTermsConditions.jsx";
...
function App() {
  ...
  const routeList = [
    ...
    {
      path: "/dash/testimonials/add-testimonial",
      comp: <AddEditTestimonial />,
    },
    {
      path: "/dash/testimonials/edit-testimonial/:id",
      comp: <AddEditTestimonial />,
    },
    ...
    { path: "/dash/privacy-policy", comp: <EditPrivacyPolicy /> },
    { path: "/dash/terms-conditions", comp: <EditTermsConditions /> },

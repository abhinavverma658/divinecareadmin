...
const Services = () => {
  ...
  const calculateStats = (servicesData) => {
    const stats = {
      ...
      active: servicesData.filter((service) => service.isActive !== false)
        .length, // Active by default
      inactive: servicesData.filter((service) => service.isActive === false)
        .length,
                  ...
                  <tr key={service._id || index}>
                    <td>
                      <div className="d-flex align-items-center">
                        {service.image1 && (
                          <Image
                            src={getImageUrl(service.image1)}
                            alt={service.title}
                            width={50}
                            height={50}
                        ...
                        <div>
                          <h6 className="mb-1" style={{ textAlign: "left" }}>
                            {service.title}
                          </h6>
                          <p
                    ...
                    <td className="text-center">
                      <Badge
                        bg={
                          service.isActive !== false ? "success" : "secondary"
                        }
                        className="me-1"
                      >
                    ...
                    <td className="text-center">
                      <div className="d-flex gap-2 justify-content-center">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            navigate(`/dash/services/edit/${service._id}`)
                          }
                        >
                          <FaEdit />
                        </Button>

...
const EditMainAboutSection = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.heading.length > 45)
      errors.push("Heading must be 45 characters or less");
    if (!formData.smallDescription.trim())
      errors.push("Small description is required");
    if (formData.smallDescription.length > 225)
      errors.push("Small description must be 2 characters or less");
    ...
    // Key points are optional - validation removed to allow blank values
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.success) {
        toast.success(
          response.message || "Main About section updated successfully!",
        );
      ...
      toast.error(
        error?.data?.message || "Failed to update main about section",
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="d-flex align-items-center">
          ...
          <div>
            ...
            <p className="text-muted mb-0">
              Manage the main about us section content
            </p>
          </div>
        </div>
              ...
              <Card.Body>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Text className="text-muted">
                    {formData.heading.length}/45 characters
                  </Form.Text>
                </Form.Group>
              ...
              <Card.Body>
                ...
                <Row className="mb-4">
                  <Col xs={6}>
                    <Form.Group>
                      <Form.Label>
                        Left Image 1 <span className="text-danger">*</span>
                      </Form.Label>
                      <div className="text-center">
                        ...
                        <Form.Control
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleImageUpload("leftImage1", e.target.files[0])
                          }
                          className="mb-2"
                  ...
                  <Col xs={6}>
                    <Form.Group>
                      <Form.Label>
                        Left Image 2 <span className="text-danger">*</span>
                      </Form.Label>
                      <div className="text-center">
                        {formData.leftImage2 && (
                          <Image
                        ...
                        <Form.Control
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleImageUpload("leftImage2", e.target.files[0])
                          }
                          className="mb-2"
                ...
                <Form.Group>
                  <Form.Label>
                    Right Main Image <span className="text-danger">*</span>
                  </Form.Label>
                  <div className="text-center">
                    {formData.rightImage && (
                      <Image
                    ...
                    <Form.Control
                      ...
                      accept="image/*"
                      onChange={(e) =>
                        handleImageUpload("rightImage", e.target.files[0])
                      }
                      className="mb-2"
            ...
            <Card className="shadow-sm border-0 mb-4">
              ...
              <Card.Body>
                <p className="text-muted mb-3">
                  Add three key points that highlight your main features or
                  benefits
                </p>
                {formData.keyPoints.map((point, index) => (
                  <Form.Group key={index} className="mb-3">
                    <Form.Label>Key Point {index + 1} </Form.Label>
                    <Form.Control
                      type="text"
                      value={point}
                      onChange={(e) =>
